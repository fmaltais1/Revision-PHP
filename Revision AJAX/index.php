...
<html lang="en">
    ...
    <body>
        <div>
            <main>
                <div id="house">
                    <img src="img/light-off.png" alt="light1" id="light-1">
                    <img src="img/light-off.png" alt="light2" id="light-2">
                    <img src="img/light-off.png" alt="light3" id="light-3">
                    <img src="img/light-off.png" alt="light4" id="light-4">
                    <img src="img/light-off.png" alt="light5" id="light-5">
                    <img src="img/light-off.png" alt="light6" id="light-6">
                </div>
            </main>
            <footer>
